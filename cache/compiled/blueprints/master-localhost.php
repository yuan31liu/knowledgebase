...
return [
    ...
    'timestamp' => 1602428488,
    'checksum' => 'caf55dc05fa15170d5108821f47694d0',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.mathjax.delimiters' => [
                'type' => '_parent',
                'name' => 'plugins.mathjax.delimiters',
                'form_field' => false
            ],
            'plugins.mathjax.delimiters.block' => [
                'type' => 'array',
                'label' => 'PLUGINS.MATHJAX.DELIMITERS.BLOCK',
                'name' => 'plugins.mathjax.delimiters.block',
                'validation' => 'strict'
            ],
            'plugins.mathjax.delimiters.inline' => [
                'type' => 'array',
                'label' => 'PLUGINS.MATHJAX.DELIMITERS.INLINE',
                'name' => 'plugins.mathjax.delimiters.inline',
                'validation' => 'strict'
            ],
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'mathjax' => [
                    ...
                    'delimiters' => [
                        'block' => 'plugins.mathjax.delimiters.block',
                        'inline' => 'plugins.mathjax.delimiters.inline'
                    ],
